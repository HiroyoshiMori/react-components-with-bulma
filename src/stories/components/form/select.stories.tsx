...
export default {
    title: 'React Component/Form/Select',
...
export const WithAttributes = {
    ...
    args: {
        attributes: {
            wrap: {'aria-label': 'Wrap Label'},
            control: {'aria-label': 'Control Label'},
...
export const WithDatasets = {
    ...
    args: {
        datasets: {
            wrap: new Map([['id', 'select-wrap']]),
            control: new Map([['id', 'select-control']]),
